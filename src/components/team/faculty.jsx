                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-speakers-box">
                                ...
                                <div className="speakers-content">
                                    ...
                                    <ul className="social">
                                        <li>
                                            <Link to="https://www.facebook.com/" target="_blank"><i className="icofont-facebook"></i></Link>
                                        </li>
                                        <li>
                                            <Link to="https://twitter.com/" target="_blank"><i className="icofont-twitter"></i></Link>
                                        </li>
                                        <li>
